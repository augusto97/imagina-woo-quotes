<?php
/**
 * Email en texto plano: nueva solicitud para el administrador.
 *
...
printf(
	...
	esc_html__( '%s ha solicitado un presupuesto.', 'imagina-woo-quotes' ) . "\n\n",
	esc_html( $order->get_formatted_billing_full_name() )
);

echo esc_html__( 'Prepararlo:', 'imagina-woo-quotes' ) . " " . esc_url( $order->get_edit_order_url() ) . "\n";
